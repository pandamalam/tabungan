...
<div class="uk-container uk-container-xsmall">
	<h1 class="uk-text-center uk-heading-primary">Pemasukan</h1>

	<hr class="uk-divider-icon">
<form method="POST" class="uk-form-horizontal uk-margin-large" action="{{ route('masuk.store') }}" enctype="multipart/form-data" >
    @csrf
    <div class="uk-margin">
